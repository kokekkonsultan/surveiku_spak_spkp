...
$route['pengguna-klien/edit-klien/(:num)'] = 'Auth/edit_klien/$1';
...
$route['(:any)/(:any)/pertanyaan-unsur/(:num)'] = 'PertanyaanUnsurSurveiController/index/$1/$2/$3';
...
//VISUALISASI
$route['(:any)/(:any)/visualisasi-data/(:num)'] = 'VisualisasiController/index/$1/$2/$3';
...
//REKAP ALASAN
$route['(:any)/(:any)/alasan/(:num)'] = 'AlasanController/index/$1/$2/$3';
...
$route['(:any)/(:any)/laporan-survey/cetak/(:num)'] = 'LaporanSurveyController/cetak/$1/$2/$3';
...
$route['(:any)/(:any)/analisa-survei/(:num)'] = 'AnalisaSurveiController/index/$1/$2/$3';
