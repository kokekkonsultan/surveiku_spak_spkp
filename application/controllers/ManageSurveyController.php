...
class ManageSurveyController extends Client_Controller
{
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $value) {
            ...
            $color = $value->is_privacy == 1 ? 'primary' : 'danger';
            $no++;
            $row = array();
			        ...
			        <div class="d-flex align-items-center">
			            ...
			            <div class="d-flex flex-column flex-grow-1">
			                <div class="row">
			                    ...
			                    <div class="col sm-2 text-right"><div class="text-dark"></div>
    ...
    public function create($username)
    {
        ...
        $object = [
            ...
            'title_header_survey'           => serialize(array("SPKP DAN SPAK", $this->input->post('organisasi'))),
            ...
            'is_layanan_survei'             => 1,
            'atribut_produk_survei'         => serialize(array('1', '2')),
            ...
            'deskripsi_opening_survey'      => '<p>Dalam rangka Pembangunan Zona Integritas dengan tujuan untuk mengetahui persepsi korupsi dan memperoleh masukan guna perbaikan layanan, Saudara dipercaya menjadi responden pada kegiatan Survei Persepsi Anti Korupsi (SPAK) dan Survei Persepsi Kualitas Pelayanan (SPKP) ini. Atas kesediaan Saudara memberikan pendapat kami sampaikan terima kasih dan penghargaan sedalam-dalamnya.</p>',
            ...
            'template_email_prospek'        => '<p>Kami Tim Survei Persepsi ${1},</p>
            ...
            'template_whatsapp_prospek'     => '<p>Kami Tim Survei Persepsi ${1}, memohon kepada Bapak/ Ibu, untuk mengisi Kuesioner ${2} dengan link berikut ini ${3}. Mohon diisi sebelum tanggal ${4}. Atas kesedian dan partisipasinya kami ucapkan Terima Kasih.</p>',
    ...
    public function link_survey($id1, $id2)
    {
        ...
        $this->data['pertanyaan_unsur_spkp'] = $this->db->query("SELECT * FROM unsur_pelayanan_$profiles->table_identity
        JOIN pertanyaan_unsur_pelayanan_$profiles->table_identity ON unsur_pelayanan_$profiles->table_identity.id = pertanyaan_unsur_pelayanan_$profiles->table_identity.id_unsur_pelayanan
        WHERE is_produk = 1")->num_rows();

        $this->data['pertanyaan_unsur_spak'] = $this->db->query("SELECT * FROM unsur_pelayanan_$profiles->table_identity
        JOIN pertanyaan_unsur_pelayanan_$profiles->table_identity ON unsur_pelayanan_$profiles->table_identity.id = pertanyaan_unsur_pelayanan_$profiles->table_identity.id_unsur_pelayanan
        WHERE is_produk = 2")->num_rows();
    ...
    public function _get_data_profile($id1, $id2)
    {
        ...
        $this->db->join('klasifikasi_survei ks', 'ks.id = u.id_klasifikasi_survei');
