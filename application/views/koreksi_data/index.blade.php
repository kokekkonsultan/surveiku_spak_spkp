                            ...
                            <table id="table-default" class="table table-bordered table-hover" cellspacing="0"
                                ...
                                <thead class="bg-light">
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2">Total SPAK</th>
                                        <th rowspan="2">Total SPKP</th>
                                        ...
                                        <th colspan="{{$row->jumlah_unsur}}" class="text-center text-primary">
                                ...
                                <table id="table" class="table table-bordered table-hover" cellspacing="0" width="100%"
                                    ...
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            @foreach($produk->result() as $row)
                                            <th colspan="{{$row->jumlah_unsur}}" class="text-center text-warning">
                                                {{$row->nama . ' (' . $row->nama_alias . ')'}}</th>
                                            @endforeach
                                        </tr>
                                        <tr>
