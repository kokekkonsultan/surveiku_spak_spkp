            ...
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <a class="btn btn-light-primary font-weight-bold" href="{{base_url().$ci->session->userdata('username').'/'.$ci->uri->segment(2).'/data-surveyor'}}">Cancel</a>
