                        ...
                        <div class="col-xl-8">
                            <div class="my-5">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th><span class="text-primary">3. Pertanyaan Unsur</span></th>
                                        <td>
                                            <?php if($pertanyaan_unsur_spkp == 0 || $pertanyaan_unsur_spak == 0): ?>
                                            <span class="badge badge-danger">Belum Diisi</span>
                                            <?php else: ?>
                                            <span class="badge badge-success">Oke</span>
                                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_spak_spkp\application\views/manage_survey/form_link_survey.blade.php ENDPATH**/ ?>