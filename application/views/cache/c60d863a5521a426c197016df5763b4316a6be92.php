    ...
    <div class="row mt-5">
        ...
        <div class="col-md-9">
            ...
            <div class="col col-lg-12">
                ...
                <?php echo anchor(base_url().$ci->session->userdata('username').'/'.$ci->uri->segment(2).'/perolehan-surveyor',
                ...
                <div class="card card-custom card-sticky">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <img src="<?php echo e(base_url()); ?>assets/klien/foto_profile/200px.jpg" alt="" class="img-fluid">
                            </div>
                            <div class="col-md-10">
                                ...
                                <table class="table table-striped">
                                    <tr>
                                        <th>Kode Surveyor</th>
                                        <td>
                                            <?php echo e($data_surveyor->kode_surveyor); ?>
                                    ...
                                    <tr>
                                        <th>Nama Lengkap</th>
                                        <td>
                                            <?php echo e($data_surveyor->first_name); ?> <?php echo e($data_surveyor->last_name); ?>
                                    ...
                                    <tr>
                                        <th>Email</th>
                                        <td>
                                            <?php echo e($data_surveyor->email); ?>
                                    ...
                                    <tr>
                                        <th>HP</th>
                                        <td>
                                            <?php echo e($data_surveyor->phone); ?>
                                        ...
                                        <td>
                                            <div class='input-group'>
                                                <input class='form-control' id='kt_clipboard_1'
                                                    value="<?php echo e(base_url()); ?>survei/<?php echo e($ci->uri->segment(2)); ?>/<?php echo e($ci->uri->segment(4)); ?>"
                                                    readonly />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a class="btn btn-light-primary font-weight-bold shadow btn-block"
                                            href="<?php echo e(base_url()); ?>survei/<?php echo e($ci->uri->segment(2)); ?>/<?php echo e($ci->uri->segment(4)); ?>"
                                            target="_blank"><i class="fas fa-link"></i>Link Survei</a>
                                    </div>

                                    <div class="col-md-6">
                                        <form action="<?php echo e(base_url()); ?>perolehan-surveyor/get-email"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_spak_spkp\application\views/perolehan_surveyor/detail_perolehan.blade.php ENDPATH**/ ?>