...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <a href="<?php echo base_url() . $ci->session->userdata('username') . '/info-berlangganan' ?>" class="menu-link">
        <span class="svg-icon menu-icon">
    ...
    <li class="menu-item {{ ($ci->uri->segment(1) == 'rekap-hasil-keseluruhan') ? 'menu-item-active' : '' }}"
        aria-haspopup="true">
